...
var n =$(document),r=$(window),i=$("html"),s=$("html, body"),
   ...
   Vt =$("li#like-fb-close"),$t=$(".profil-dep-home p.labels-tag"),Jt=$("#comment-editor"),Kt=$(".tag_labels"),Qt=$(".eightcol.last.tag"),
...
var tescription = $('.item .eightcol.last.author');
...
blogStats.child('value').set(data.value);
    Cufon.replace(".statistic",{fontFamily:"knockout49",textShadow: "1px 1px 2px #000"});
}
});
});
...
var grid2 =$('.eightcol.last.comment');
grid2.append('<ul class="comment-x-post"/>');
var comment_x_post =$('.comment-x-post'),top_comment =$('li.items-cmx');
comment_x_post.html(top_comment);
