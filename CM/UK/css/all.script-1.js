...
var n =$(document),r=$(window),i=$("html"),s=$("html, body"),
   ...
   on ='<ul class="share-wrapper"><h2>Share this : '+dataposttitle+'</h2><li><a class="fb_share" href="http://www.facebook.com/sharer.php?u='+dataposturl+'" target="_blank"><span class="item-c">Facebook</span></a></li><li><a class="twitter_share" href="http://twitter.com/share?url='+dataposturl+'" target="_blank"><span class="item-c">Twitter</span></a></li><li><a class="google_share" href="https://plus.google.com/share?url='+dataposturl+'" target="_blank"><span class="item-c">Google+</span></a></li></ul><span class="likes-frame"><span class="iframe-wrap"><iframe class="fb-item" allowTransparency="true" frameborder="0" scrolling="no" src="http://www.facebook.com/plugins/like.php?href='+ dataposturl+'&send=false&layout=button_count&show_faces=false&width=79&action=like&colorscheme=light"></iframe></span><span class="count-likes-fb"/></span>';
    ...
    $('pre').each(function () {
        ...
        for (var line = 1; line < lines.length + 1; line++) {
            ...
            $.getJSON('http://api.sharedcount.com/?url=' + dataposturl , function (data) {
                ...
                $('a.fb_share').prepend('<span class="fb-c share-count">' + share_count + '</span>');
                $('a.twitter_share').prepend('<span class="tw-c share-count">' + Twitter_count + '</span>');
                $('a.google_share').prepend('<span class="gp-c share-count">' + gplus_count + '</span>');
...
$(".eightcol.last.share").append('<div class="so-network"><p class="title">urang-kurai on the social network</p><div class="share-so-net"><a class="so-net twitter-p" href="https://twitter.com/andre_pandet" target="_blank"></a><a class="so-net facebook-p" href="https://www.facebook.com/urang.kurai.blogspot" target="_blank"></a><a class="so-net google-p" href="https://plus.google.com/u/0/b/106325523605395321607/" target="_blank"></a></div></div>');
...
$(".show_comments.post-share").click(function () {
  ...
  vnkfs.each(function() {
$(this).append('<span class="counter-text"></span>');
