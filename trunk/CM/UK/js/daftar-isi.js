...
// this function creates a three-column table and adds it to the screen
   ...
   var tocTable = '';
   var tocHead2 = 'JUDUL';
   var tocTool2 = 'Click to sort by title';
   var tocHead1 = 'TANGGAL';
   var tocTool1 = 'Click to sort by date';
   var tocHead3 = '';
   var tocTool3 = '';
   if (sortBy == "titleasc") { 
      tocTool1 += ' (descending)';
   ...
   for (var i = 0; i < postTitle.length; i++) {
      if (filter == '') {
         tocTable += '<tr><td class="tanggal">' + postDate[i] + '</td><td class="judul-posting"><a href="' + postUrl[i] + '" title="' + postUrl[i] + '">' + postTitle[i] + '</a></td></tr>';
         numDisplayed++;
      } else {
...
function hideToc() {
  ...
  tocdiv.innerHTML = '';
  var toclink = document.getElementById("toclink");
  toclink.innerHTML = '<a href="#" onclick="scroll(0,0); showToc(); Effect.toggle('+"'toc-result','blind');"+'">? Show Table of Contents</a> <img src="http://1.bp.blogspot.com/-W7YKdLpaYy0/T1PT-Qo7CYI/AAAAAAAAHhM/CITgXKbzH4M/s1600/new_1.gif.png"/>';
}
